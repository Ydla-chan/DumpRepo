 ...
 <div class="flex flex-col md:flex-row flex-1 overflow-hidden">
            ...
            <aside class="w-full md:w-1/3 lg:w-1/4 bg-white p-6 border-b md:border-b-0 md:border-r border-slate-200 overflow-y-auto custom-scrollbar">
                ...
                <div class="mt-4 space-y-4 text-sm">
                    ...
                    <div class="flex items-start gap-3 text-slate-600"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mt-0.5 shrink-0" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd" /></svg><span>Ruang Rapat Merdeka, Lantai 5</span></div>
                </div>

                <h2 class="text-lg font-bold text-slate-900 pb-3 border-b border-slate-200 mt-8">Peserta Rapat</h2>
                <div class="mt-4 space-y-3">
                    <div class="flex items-center gap-3"><img src="https://i.pravatar.cc/150?u=andi" alt="Andi" class="w-10 h-10 rounded-full object-cover"><div><p class="font-semibold text-sm">Andi Pratama</p><p class="text-xs text-slate-500">Sales Manager</p></div></div>
                    <div class="flex items-center gap-3"><img src="https://i.pravatar.cc/150?u=citra" alt="Citra" class="w-10 h-10 rounded-full object-cover"><div><p class="font-semibold text-sm">Citra Lestari</p><p class="text-xs text-slate-500">Marketing Lead</p></div></div>
                    <div class="flex items-center gap-3"><img src="https://i.pravatar.cc/150?u=dani" alt="Dani" class="w-10 h-10 rounded-full object-cover"><div><p class="font-semibold text-sm">Dani Kurniawan</p><p class="text-xs text-slate-500">Tech Lead</p></div></div>
                </div>
